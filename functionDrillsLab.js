...
const nameGreeting = nameCheck("Cam")
...
console.log(bigOrSmallArray, arrayEvaluator)
...
console.log(emailCheck("hdjfhd sjfh@hfdf"))
...
//CODE HERE
const purchase2 = (gold) => {
  const totalFrogs2 = Math.floor( gold / 3)
  return totalFrogs2
}
totalFrogs2 = purchase2(12)
